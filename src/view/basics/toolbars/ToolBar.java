				...
				if (!MainControl.drawings.isEmpty())
				{
					try
					{
						...
						String x_s = (String) JOptionPane.showInputDialog(null, 
								"<html>Enter a translate factor for <b><font color= blue>x-axis</b></font> between <b><font color= blue>-100 to 100</b></font>:</html>", "Prompt", JOptionPane.PLAIN_MESSAGE);
						...
						while(x<-100 || x>100)
						{
							x_s = (String) JOptionPane.showInputDialog(null, 
									"<html>Please enter a <b><font color= red>valid</b></font> translate factor for <b><font color= blue>x-axis</b></font> between <b><font color= blue>-100 to 100</b></font>:</html>", "Prompt", JOptionPane.PLAIN_MESSAGE);
						...
						if (!(x < -100 || x > 100)) 
						{
							String y_s = (String) JOptionPane.showInputDialog(null, 
									"<html>Enter a translate factor for <b><font color= blue>y-axis</b></font> between <b><font color= blue>-100 to 100</b></font>:</html>", "Prompt", JOptionPane.PLAIN_MESSAGE);
							double y = Double.parseDouble(y_s);
							
							while(y<-100 || y>100)
							{
								y_s = (String) JOptionPane.showInputDialog(null, 
										"<html>Please enter a <b><font color= red>valid</b></font> translate factor <html><b><font color= blue>for y-axis</b></font> between <b><font color= blue>-100 to 100</b></font>:</html>", "Prompt", JOptionPane.PLAIN_MESSAGE);
			...
			public void actionPerformed(ActionEvent e) 
			{
				...
				if (!MainControl.drawings.isEmpty()) 
				{
					try 
					{
						...
						String x_s = (String) JOptionPane.showInputDialog(null, 
								"<html>Enter a scale factor for <b><font color= blue>x-axis</b></font> between <b><font color= blue>0 to 5</b></font>:</html>", "Prompt", JOptionPane.PLAIN_MESSAGE);
						...
						{
							x_s = (String) JOptionPane.showInputDialog(null, 
									"<html>Please enter a <b><font color= red>valid</b></font> scaling factor for <b><font color= blue>x-axis</b></font> between <b><font color= blue>0 to 5</b></font>:</html>", "Prompt", JOptionPane.PLAIN_MESSAGE);
							x = Double.parseDouble(x_s);
						}
						...
						{
							String y_s = (String) JOptionPane.showInputDialog(null, 
									"<html>Enter a scale factor for <b><font color= blue>y-axis</b></font> between <b><font color= blue>0 to 5</b></font>:</html>", "Prompt", JOptionPane.PLAIN_MESSAGE);
							double y = Double.parseDouble(y_s);
							
							while(y<0 || y>5)
							{
								x_s = (String) JOptionPane.showInputDialog(null, 
										"<html>Please enter a <b><font color= red>valid</b></font> scaling factor for <b><font color= blue>y-axis</b></font> between <b><font color= blue>0 to 5</b></font>:</html>", "Prompt", JOptionPane.PLAIN_MESSAGE);
								y = Double.parseDouble(x_s);
							}
